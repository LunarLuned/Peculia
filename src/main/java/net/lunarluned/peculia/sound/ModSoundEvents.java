...
public class ModSoundEvents {
    ...
    public static final SoundEvent ITEM_GENERIC_TOME_CROWD_FAIL = registerSoundEvent("item.generic_tome.crowd_fail");

    public static final SoundEvent ITEM_HEALING_TOME_USE = registerSoundEvent("item.healing_tome.use");
    public static final SoundEvent ITEM_HEALING_TOME_CROWD_USE = registerSoundEvent("item.healing_tome.crowd_use");

    public static final SoundEvent ITEM_UPDRAFT_TOME_USE = registerSoundEvent("item.updraft_tome.use");
    public static final SoundEvent ITEM_UPDRAFT_TOME_CROWD_USE = registerSoundEvent("item.updraft_tome.crowd_use");
    ...
    public static final SoundType FLUORITE_BRICKS = new SoundType(1f, 1f,
    ...
    public static final SoundType POPROCKS = new SoundType(1f, 1f,
    ...
    private static SoundEvent registerSoundEvent(String name) {
        ResourceLocation id = new ResourceLocation(Peculia.MOD_ID, name);
