...
public class ModEntities {
    ...
    public static final EntityType<MoldspawnEntity> MOLDSPAWN = register("moldspawn", EntityType.Builder.of(MoldspawnEntity::new, MobCategory.MONSTER).sized(0.7f, 0.85f).fireImmune().clientTrackingRange(10));
