...
public class ModFoodComponents {
    ...
    public static final FoodComponent RAW_BACON = (new FoodComponent.Builder().hunger(2).saturationModifier(0.1f).snack().statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 100, 1), 0.7F).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 200, 1), 0.7F).build());
    public static final FoodComponent COOKED_BACON = (new FoodComponent.Builder().hunger(3).saturationModifier(0.1f).snack().build());
    public static final FoodComponent BEEF_PATTY = (new FoodComponent.Builder().hunger(2).saturationModifier(0.1f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 100, 1), 0.1F).build());
    ...
    public static final FoodComponent COCOA_SPREAD = (new FoodComponent.Builder().hunger(4).saturationModifier(1f).snack().statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 40, 0), 1F).build());
    ...
    public static final FoodComponent CACTUS_SPREAD_TOAST = (new FoodComponent.Builder().hunger(11).saturationModifier(6f).snack().statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 70, 0), 0.1F).build());
    ...
    public static final FoodComponent PORK_SPREAD_TOAST = (new FoodComponent.Builder().hunger(12).saturationModifier(6f).snack().statusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 70, 0), 0.1F).build());
}
