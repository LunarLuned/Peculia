...
public class FlyingPaperParticles extends RisingParticle {

    public FlyingPaperParticles(ClientLevel level, double x, double y, double z, double velX, double velY, double velZ) {
    ...
    public record Factory(SpriteSet sprites) implements ParticleProvider<SimpleParticleType> {
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel world, double x, double y, double z, double velX, double velY, double velZ) {
            FlyingPaperParticles particle = new FlyingPaperParticles(world, x, y, z, velX, velY, velZ);
