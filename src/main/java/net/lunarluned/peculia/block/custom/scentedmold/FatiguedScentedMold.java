...
public class FatiguedScentedMold extends GenericScentedMoldBlock {

    public FatiguedScentedMold(Properties properties) {
        super(properties);
    }
    ...
    public void animateTick(BlockState blockState, Level level, BlockPos pos, RandomSource randomSource) {
        ...
        if (blockState.getValue(LIT)) {
            ...
            for (LivingEntity livingEntity : nearbyEntities) {
                livingEntity.addEffect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 300, 1, true, true, true));
            }
        }
