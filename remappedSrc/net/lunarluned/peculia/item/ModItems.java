...
public class ModItems {
    ...
    new Item(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).maxCount(1).rarity(net.minecraft.world.item.Rarity.UNCOMMON)));
    ...
    new PeculiarDaggerItem(ModToolMaterials.PECULIAR,3, -2.0f,new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).maxCount(1).rarity(net.minecraft.world.item.Rarity.EPIC)));

    public static final Item PECULIAR_SWORD = registerItem("peculiar_sword",
    new PeculiarDaggerItem(ModToolMaterials.PECULIAR,5, -2.5f,new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).maxCount(1).rarity(net.minecraft.world.item.Rarity.EPIC)));

    public static final Item SOUL = registerItem("soul",
    new SoulItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON)));
    ...
    new LesserHealingTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(32)));

    public static final Item TOME_OF_HEALING = registerItem("tome_of_healing",
    new HealingTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(64)));
    ...
    new LesserUpdraftTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(32)));

    public static final Item TOME_OF_UPDRAFT = registerItem("tome_of_updraft",
    new UpdraftTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(64)));
    ...
    new LesserEmpoweringTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(32)));

    public static final Item TOME_OF_EMPOWERING = registerItem("tome_of_empowering",
    new EmpoweringTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(64)));
    ...
    new LesserAgilityTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(32)));

    public static final Item TOME_OF_AGILITY = registerItem("tome_of_agility",
    new AgilityTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(64)));
    ...
    new LesserFortifyingTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(32)));

    public static final Item TOME_OF_FORTIFYING = registerItem("tome_of_fortifying",
    new FortifyingTomeItem(new FabricItemSettings().group(ModItemGroup.PECULIA_MISC).rarity(net.minecraft.world.item.Rarity.UNCOMMON).maxDamage(64)));
    ...
    new Item(new FabricItemSettings().group(ModItemGroup.PECULIA).maxCount(1).rarity(net.minecraft.world.item.Rarity.COMMON)));

    public static final Item ECHOING_MIRROR = registerItem("echoing_mirror",
    new EchoingMirrorItem(new FabricItemSettings().group(ModItemGroup.PECULIA).maxCount(1).rarity(net.minecraft.world.item.Rarity.RARE).maxDamage(16)));
    ...
    new FabricItemSettings().rarity(net.minecraft.world.item.Rarity.RARE).maxCount(1).group(ModItemGroup.PECULIA), 194));
    ...
    new SculkSacItem(new FabricItemSettings().group(ModItemGroup.PECULIA_OVERWORLD).rarity(net.minecraft.world.item.Rarity.UNCOMMON)));

    public static final Item FULL_SCULK_SAC = registerItem("full_sculk_sac",
    new FullSculkSacItem(new FabricItemSettings().group(ModItemGroup.PECULIA_OVERWORLD).rarity(net.minecraft.world.item.Rarity.UNCOMMON)));
    ...
    private static Item registerItem(String name, Item item) {
        return net.minecraft.core.Registry.register(net.minecraft.core.Registry.ITEM, new ResourceLocation(Peculia.MOD_ID, name), item);
    }
